...
class Strain(models.Model):
    ...
    name = models.CharField(max_length=160, unique=True, blank=False)
    summary = models.TextField(blank=True, null=True)
    ocpc = models.CharField(max_length=160, unique=True, blank=False)
    ...
    def get_absolute_url(self):
        ...
        return reverse("strains:strain_detail", kwargs={"pk": self.pk})
